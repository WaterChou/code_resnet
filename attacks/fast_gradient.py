...
def fgm(model, x, is_training, classes = 8, eps=0.01, epochs=1, sign=True, clip_min=0., clip_max=1.):
    """
    ...
    ybar = model(xadv, is_training ,classes=8)
    ...
    def _body(xadv, i):
        ybar, logits = model(xadv, is_training, logits=True)
